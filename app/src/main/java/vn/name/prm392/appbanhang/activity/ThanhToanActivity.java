...
import vn.name.prm392.appbanhang.model.CreateOrder;
...
import vn.name.prm392.appbanhang.retrofit.ApiPushNofication;
import vn.name.prm392.appbanhang.retrofit.RetrofitClient;
import vn.name.prm392.appbanhang.retrofit.RetrofitClientNoti;
        ...
        btndathang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(str_diachi)){
                    ...
                    Log.d("test", new Gson().toJson(Utils.mangmuahang));  // kiem tra thui ma
